...
?>
				<center>
				<hr>
					<table border="0" width="680" align="center" style="margin-top:20px; margin-bottom:20px;">
						<tr valign="top">
							<td align="center"> 
...
function ShowLightDetailVPS($vpsid)
{
	...
	// on recupere la date d'expiration et de création && commentaire client
			$sql_vps = DB:: SQLToArray("SELECT * FROM vps WHERE id='$vpsid' LIMIT 1");
					
			$date_expiration = $sql_vps[0]['expiration'];
			$date_creation =  $sql_vps[0]['creation'];
			$commentair_client =  $sql_vps[0]['commentaire'];
	...
	echo "
        <center>
            ...
            <td> <b>Date d'Expiration</b> : ";
                ...
                echo date('d/m/Y',$date_expiration);
							else
                echo " - ";
            echo "
            </td>
					...
					<table width=\"500\" style=\"margin-top:10px; margin-bottom:10px;\">
					<tr>
            <td>
            <b>Traffic (Mois en cours)</b> :
						</td>
            <td>
							<img src=\"images/upload.png\" width=\"15\" height=\"15\" align=\"absmiddle\" alt=\"\"/>Transmis : $TX
						</td>
						<td> 
							<img src=\"images/download.png\" width=\"15\" height=\"15\" align=\"absmiddle\" alt=\"\"/>Reçus : $RX
						</td>
					</tr>
					<tr>
            <td>
            ...
            <td>
							<img src=\"images/upload.png\" width=\"15\" height=\"15\" align=\"absmiddle\" alt=\"\"/>Transmis : ".$vpsinfo['deb_TX']."
						</td>
						<td> 
							<img src=\"images/download.png\" width=\"15\" height=\"15\" align=\"absmiddle\" alt=\"\"/>Reçus : ".$vpsinfo['deb_RX']."
						</td>
					</tr>	
				</table>
				</center>
